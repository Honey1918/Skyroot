from delhi_landmarks import delhi_landmarks
from delhi_metro import delhi_metro
...
def greet():
    ...
    print("We'll help you find the shortest route between the following Delhi landmarks:")
...
def get_active_stations():
    updated_metro = delhi_metro
    for station_under_construction in stations_under_construction:
        for current_station, neighboring_stations in delhi_metro.items():
...
def get_route(start_point, end_point):
    ...
    start_stations = delhi_landmarks.get(start_point, set())
    end_stations = delhi_landmarks.get(end_point, set())

    if start_stations == end_stations:
        return ["No need to travel, you're already there!"]

    metro_system = get_active_stations() if stations_under_construction else delhi_metro
